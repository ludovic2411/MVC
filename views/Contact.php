   ...
   <body>
     ...
     include 'Contact-header.php';
      ...
      <section class="Contact">
        ...
        <button type="button" name="email"><a href="dmotte@skynet.be">dmotte@skynet.be</a></button>
        <section "address">
          <p>+32 495 20.59.34</p>
          <p>Rue Saint Georges 35</p>
          <p>B-1400 Nivelles</p>
          <p>Belgique.</p>
          <p>Retrouvez nos mises à jour en vous <button type="button" name="facebook"><a href="https://www.facebook.com/antiquites.decoration"></a> abonnant à notre page facebook</button></p>
        </section>
      </section>
      <section class="maps">
      ...
      <section class="itinéraire">
        <form class="from" action="Contact.php" method="post">
          <p>Lieu de départ: <input type="text" name="from" value="">
            <input type="submit" class="search_destination" name="search_destination" value="Itinéraire">
          </p>
        </form>
      </section>
    </section>
